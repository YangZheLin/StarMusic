...
//		Log.d("SlidingMenu", "dispatchTouchEvent: ");
		return super.dispatchTouchEvent(ev);
	}

//	@Override
//	public boolean onInterceptHoverEvent(MotionEvent event) {
//		Log.d("SlidingMenu", "onInterceptHoverEvent: ");
//		return false;
//	}
	@Override
...
//		ViewHelper.setScaleY(mContent, rightScale);
	...
	public void setChenJIngShi(ChenJingShi cjs){
		mCjs=cjs;
	}
	private ChenJingShi mCjs;
public interface  ChenJingShi{
	void asOpenMenu();
	void asCloseMenu();
}
}
